    ...
    public partial class Form1 : System.Windows.Forms.Form
    {
        ...
        public static HttpClient client_login()
        {
            try
            {
                ...
                //specify to use TLS 1.2 as default connection1
        ...
        private void textBox_x_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == (Keys.Control | Keys.V))
                (sender as System.Windows.Forms.TextBox).Paste();
        }

        private void textBox_y_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyData == (Keys.Control | Keys.V))
                (sender as System.Windows.Forms.TextBox).Paste();
        }
